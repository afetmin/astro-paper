...
tags:
  - astro
description:
  为 AstroPaper 博客主题精心设计的一些预定义配色方案。
---

我为这个 AstroPaper 博客主题设计了一些预定义的配色方案。你可以用这些配色方案替换原始方案。
...
浅色配色方案需要使用 CSS 选择器 `:root` 和 `html[data-theme="light"]` 来定义。
...
深色配色方案需要使用 `html[data-theme="dark"]` 来定义。
