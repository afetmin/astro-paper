...
​![image](@assets/images/浏览器底层运行原理/image-20230822202639-01u8go0.png)V8 在执行过程中既有解释器 Ignition，又有编译器 TurboFan，此外较新版本的 Chrome 增加了一种中间层编译器 Maglev，V8 可以使用 jsvu 进行本地调试。
